 ...
 * 
 */
@WebServiceClient(name = "StudentServiceService", targetNamespace = "http://WebService.tp1/", wsdlLocation = "http://localhost:2525/EtudiantService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTSERVICESERVICE_QNAME = new QName("http://WebService.tp1/", "StudentServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:2525/EtudiantService?wsdl");
    ...
    public StudentService getStudentServicePort() {
        return super.getPort(new QName("http://WebService.tp1/", "StudentServicePort"), StudentService.class);
    }
    ...
    public StudentService getStudentServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://WebService.tp1/", "StudentServicePort"), StudentService.class, features);
    }
